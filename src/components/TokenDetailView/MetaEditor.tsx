...
import styles from '../../styles/components/tokenDetail/MetaEditor.module.css'
          ...
          <div className={styles.tabContent}>
            <div className={styles.formGroup}>
              ...
              <textarea
                ...
                value={localSynopsis}
                onChange={(e) => {
                  setLocalSynopsis(e.target.value)
                  debouncedUpdate('synopsis', e.target.value)
                }}
                placeholder="Brief synopsis of the script"
                rows={3}
              />
            </div>

            <div className={styles.formGroup}>
              <label htmlFor="meta-overview">Overview</label>
              <textarea
                id="meta-overview"
                value={localOverview}
                onChange={(e) => {
                ...
                placeholder="Detailed overview of the script's theme, mechanics, and playstyle"
                rows={5}
              />
            </div>

            <div className={styles.formGroup}>
              <label htmlFor="meta-changelog">Changelog</label>
              <textarea
                id="meta-changelog"
                value={localChangelog}
                onChange={(e) => {
                  setLocalChangelog(e.target.value)
                  debouncedUpdate('changelog', e.target.value)
                }}
