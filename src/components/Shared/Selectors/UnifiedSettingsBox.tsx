...
function UnifiedSettingsBoxInner<T>({
  ...
  const updateField = useCallback(<K extends keyof T>(key: K, fieldValue: T[K]) => {
  ...
  const displayValue = isExpanded ? pendingValue : value
    ...
    >
      ...
      <div className={styles.previewArea}>
        ...
        <div className={styles.preview}>
          {preview.render()}
          {preview.badge && (
            <div className={styles.previewBadge}>{preview.badge}</div>
          )}
        </div>
      </div>
