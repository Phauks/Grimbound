    ...
    <div className={styles.container}>
      <div className={styles.item}>
        ...
        <span className={styles.value}>
          {counts.townsfolk.characters} / {counts.townsfolk.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.outsider}:</span>
        <span className={styles.value}>
          {counts.outsider.characters} / {counts.outsider.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.minion}:</span>
        <span className={styles.value}>
          {counts.minion.characters} / {counts.minion.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.demon}:</span>
        <span className={styles.value}>
          {counts.demon.characters} / {counts.demon.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.traveller}:</span>
        <span className={styles.value}>
          {counts.traveller.characters} / {counts.traveller.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.fabled}:</span>
        <span className={styles.value}>
          {counts.fabled.characters} / {counts.fabled.reminders}
        </span>
      </div>
      <div className={styles.item}>
        <span className={styles.label}>{TEAM_LABELS.loric}:</span>
        <span className={styles.value}>
          {counts.loric.characters} / {counts.loric.reminders}
        </span>
      </div>
      <div className={styles.item}>
      ...
      <div className={`${styles.item} ${styles.total}`}>
        ...
        <span className={styles.value}>
          {counts.total.characters + metaTokenCount} / {counts.total.reminders}
        </span>
      </div>
    </div>
  );
