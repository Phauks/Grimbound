...
export function TokenEditor({
  ...
  const [jsonText, setJsonText] = useState(() =>
    JSON.stringify(getExportableCharacter(character), null, 2)
  );
  ...
  }, [character, getExportableCharacter]);
  ...
  const _handleJsonBlur = useCallback(() => {
  ...
  const _handleRemoveReminder = (index: number) => {
  ...
  const handleReminderTextChange = useCallback(
  ...
  const handleReminderCountChange = useCallback(
  ...
  const handleRemoveGroupedReminder = useCallback(
    (text: string) => {
      setReminders((prev) => {
      ...
      <div className={styles.tabsContainer}>
        ...
        {activeTab === 'info' && (
          <div className={`${styles.tabContent} ${isOfficial ? styles.disabled : ''}`}>
            ...
            <div
              className={`${styles.formGroup} ${styles.teamSelectGroup} ${teamSelectClassMap[character.team] || ''}`}
            >
                ...
                {localImages.map((url, index) => {
                  ...
                  >
                    <span
                      ...
                      title={localImages.length > 1 ? 'Drag to reorder' : ''}
                    >
                      ⋮⋮
                    </span>
                    {url.trim() && (
            ...
            <div className={styles.formGroup}>
              ...
              <p className={styles.fieldHint}>
                Setup text [in brackets] enables this automatically. Enabling this adds [] if not
                present.
              </p>
            </div>
              ...
              <div className={styles.remindersUrlsList} role="list" aria-labelledby="reminders-label">
                {groupedReminders.map(({ text, count }, index) => {
                  ...
                  >
                    <span
                      className={styles.dragHandle}
                      title={groupedReminders.length > 1 ? 'Drag to reorder' : ''}
                    >
                      ⋮⋮
                    </span>
                    <input
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleReminderCountChange(text, parseInt(val, 10) || 1);
                      }}
                      onBlur={(e) => {
                        if (isOfficial) return;
            ...
            <div className={styles.formGroup}>
              ...
              />
              <p className={styles.fieldHint}>
                Use *TEXT* for bold, :reminder: for reminder circle.
              </p>
                      ...
                      >
                        <div className={styles.specialItemHeader}>
                          ...
                          <button
                            ...
                            disabled={isOfficial}
                            title={
                              isOfficial ? 'Official character - cannot edit' : 'Remove special'
                            }
                          >
                            ✕
                          </button>
                          ...
                          <div className={styles.specialField}>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                updateSpecialItem({
                                  value:
                                    !Number.isNaN(numVal) && val === String(numVal) ? numVal : val,
                                });
                              }}
            ...
            <div className={styles.jsonTabContent}>
                ...
                <>
                  <div className={styles.jsonHeader}>
                    <p className={styles.jsonDescription}>
                      Edit the raw JSON data for this character.
                    </p>
              ...
              {jsonSubTab === 'metadata' && (
                <div className={styles.metadataView}>
                  <div className={styles.jsonHeader}>
                    <p className={styles.jsonDescription}>
                      Internal metadata for this character (read-only).
                    </p>
                    <div className={styles.jsonButtons}>
                      <button
                        type="button"
