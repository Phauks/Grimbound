...
export function ProjectEditor({ project, scriptNameTokenCache, onExport, onDelete, onDuplicate, onCreateProject, onImportProject, onLoadLastProject, lastProject }: ProjectEditorProps) {
  ...
  }, [project?.id, isActiveProject, setTokens, displayMode, previewTokens.length])
  ...
  }, [project?.id, isActiveProject, tokens.length, isGeneratingPreview, setTokens, displayMode])
                  ...
                  <div className={styles.listSettingsPopover}>
                    ...
                    <label className={styles.listSettingsOption}>
                      <input
                        ...
                        onChange={(e) => setListViewSettings(prev => ({ ...prev, showAbility: e.target.checked }))}
                      />
                    ...
                    <label className={styles.listSettingsOption}>
                      <input
                        ...
                        onChange={(e) => setListViewSettings(prev => ({ ...prev, showFirstNightReminder: e.target.checked }))}
                      />
                    ...
                    <label className={styles.listSettingsOption}>
                      <input
                        ...
                        onChange={(e) => setListViewSettings(prev => ({ ...prev, showOtherNightReminder: e.target.checked }))}
                      />
                    ...
                    <label className={styles.listSettingsOption}>
                      <input
                        ...
                        onChange={(e) => setListViewSettings(prev => ({ ...prev, showReminders: e.target.checked }))}
                      />
                      <span>Reminders</span>
                    </label>
                  </div>
