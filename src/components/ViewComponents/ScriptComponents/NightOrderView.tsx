        ...
        <div className={layoutStyles.panelContent}>
          ...
          <details className={layoutStyles.sidebarCard} open>
            ...
            <div className={layoutStyles.optionSection}>
              <OptionGroup
                label="Generate Night Order"
                description="Create night order sheets from script"
              >
                <input
                  type="checkbox"
            ...
            <details className={layoutStyles.sidebarCard}>
              ...
              <div className={layoutStyles.optionSection}>
                ...
                <div className={styles.infoRow}>
                  ...
                  <span className={styles.infoValue}>{firstNight.entries.length} entries</span>
                </div>
                <div className={styles.infoRow}>
                  <span className={styles.infoLabel}>Other Nights</span>
                  <span className={styles.infoValue}>{otherNight.entries.length} entries</span>
                </div>
              </div>
            </details>
          )}
