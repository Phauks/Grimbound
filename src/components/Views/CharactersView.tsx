...
export function CharactersView({ initialToken, selectedCharacterUuid: externalSelectedUuid, onCharacterSelect, onGoToTokens, createNewCharacter }: CharactersViewProps) {
  ...
  }, [displayCharacterToken, displayReminderTokens, editedCharacter, selectedCharacter, generationOptions.pngSettings, addToast])
    ...
    if (hasCharacter) {
      downloads.push(
        ...
        },
        {
          ...
          description: hasReminderTokens ? `${displayReminderTokens.length} reminders (ZIP)` : 'No reminders',
