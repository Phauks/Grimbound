...
interface ThemeContextValue {
  ...
  updateCustomTheme: (themeId: string, updates: Partial<Omit<CustomTheme, 'id' | 'isCustom'>>) => void
...
export function ThemeProvider({ children }: ThemeProviderProps) {
  ...
  const currentTheme = customThemes.find(t => t.id === currentThemeId) || getTheme(currentThemeId)
  ...
  const updateCustomTheme = useCallback((themeId: string, updates: Partial<Omit<CustomTheme, 'id' | 'isCustom'>>) => {
    setCustomThemes(prev => {
