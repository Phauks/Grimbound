 ...
 */
export async function generateStyledQRCode(options: StyledQRCodeOptions): Promise<HTMLCanvasElement> {
    const {
        text,
        size,
        logoUrl,
    ...
    try {
        ...
        if (dotsUseGradient) {
            dotsOptions.gradient = createGradient(dotsGradientType, dotsColorStart, dotsColorEnd, dotsGradientRotation);
        } else {
        ...
        if (cornerSquareUseGradient) {
            cornersSquareOptions.gradient = createGradient(cornerSquareGradientType, cornerSquareColorStart, cornerSquareColorEnd);
        } else {
        ...
        if (cornerDotUseGradient) {
            cornersDotOptions.gradient = createGradient(cornerDotGradientType, cornerDotColorStart, cornerDotColorEnd);
        } else {
        ...
        if (backgroundUseGradient) {
            ...
            backgroundOptions.gradient = createGradient(backgroundGradientType, startWithOpacity, endWithOpacity);
        } else {
