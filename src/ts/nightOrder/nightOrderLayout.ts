 ...
 */
export function estimateEntryHeight(entry: NightOrderEntry, scaleFactor: number = 1.0): number {
 ...
 */
function calculateTotalHeight(entries: NightOrderEntry[], scaleFactor: number): number {
