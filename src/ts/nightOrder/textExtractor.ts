/**
 * Text Extractor for Night Sheet
 *
...
export interface ExtractedText {
  ...
  type: 'title' | 'scriptName' | 'characterName' | 'ability' | 'reminderToken' | 'reminderCircle' | 'other';
  /** Line height ratio */
  lineHeight: number;
}
...
/**
 * Extract all text from a night sheet container
 *
