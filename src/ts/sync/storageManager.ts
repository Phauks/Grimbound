...
export class StorageManager {
  ...
  private async _initializeDatabase(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(new StorageError('Failed to open IndexedDB', 'indexeddb', request.error as Error));
      };
  ...
  async storeCharacters(characters: Character[], version: string): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      transaction.onerror = () => {
        reject(
          new StorageError('Failed to store characters', 'indexeddb', transaction.error as Error)
        );
      };
  ...
  async getCharacter(id: string): Promise<CachedCharacter | null> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError(`Failed to get character: ${id}`, 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async getAllCharacters(): Promise<CachedCharacter[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError('Failed to get all characters', 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async clearCharacters(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => resolve();
      request.onerror = () => {
        reject(new StorageError('Failed to clear characters', 'indexeddb', request.error as Error));
      };
    });
  }
  ...
  async setMetadata(key: string, value: string | number | boolean): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError(`Failed to set metadata: ${key}`, 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async getMetadata(key: string): Promise<string | number | boolean | null> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError(`Failed to get metadata: ${key}`, 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async getAllMetadata(): Promise<Map<string, string | number | boolean>> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(new StorageError('Failed to get all metadata', 'indexeddb', request.error as Error));
      };
    });
  }
  ...
  async setSetting(key: string, value: unknown): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError(`Failed to set setting: ${key}`, 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async getSetting(key: string): Promise<unknown> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onerror = () => {
        reject(
          new StorageError(`Failed to get setting: ${key}`, 'indexeddb', request.error as Error)
        );
      };
    });
  }
  ...
  async clearAll(): Promise<void> {
    await Promise.all([this.clearCharacters(), this.clearImageCache()]);
